...
from .core import (UVKernelError, doctor, ensure_ipykernel, find_project, install,
                   matching, owned_kernels, remove, stale)
...
def parser() -> argparse.ArgumentParser:
    ...
    sub.add_parser("register", help="Register the current uv project as a Jupyter kernel.",
        description="Adds ipykernel as a development dependency by default and writes a standard user kernelspec.") \
        .add_argument("--no-add-ipykernel", action="store_true", help="Do not run `uv add --dev ipykernel` first.")
